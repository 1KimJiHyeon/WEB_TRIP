...
module.exports = function(passport) {
  ...
  const callbackURL = (process.env.NODE_ENV == 'production') ?
    // 'https://murmuring-mesa-59571.herokuapp.com/auth/facebook/callback' :
    'https://sleepy-hollows-18182.herokuapp.com/auth/facebook/callback':
  ...
  passport.use(new FacebookStrategy({
    ...
    clientID : process.env.FBID || '1237936453065732',
    clientSecret : process.env.FB_SECRETE || 'b73e313cf615e2655767795798ca09b5',
